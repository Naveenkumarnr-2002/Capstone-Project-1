...
public class PassengerController {
    ...
    public String serachbus(@RequestParam("form") String form,
        ...
        if (busesDtos.isEmpty()) {
            model.addAttribute("errorMessage", "No Available Bus for This Destination.");
        } else {
...
//        } else {
            model.addAttribute("tickets", ticketBookingList); // or handle with a custom message
